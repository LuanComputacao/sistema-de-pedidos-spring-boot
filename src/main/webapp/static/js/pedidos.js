...
Pedido = {
    ...
    \   <b>Cliente: </b>: <span class="js-pedido-cliente"></span><br> \
    ...
    init: function () {
        ...
        this.models.clienteID = this.elements.form.clienteID.val() || this.elements.form.clienteID.data('value');
        ...
        this.elements.form.clienteID.val(this.models.clienteID);
    ...
    watchers: {
        form: function () {
            ...
            form.clienteID.on("change", function (e) {
                Pedido.models.clienteID = form.clienteID.val();
            });
    ...
    methods: {
        save: function () {
            $.ajax({
                ...
                data: JSON.stringify({
                    id: Pedido.models.id,
                    clienteID: Pedido.models.clienteID,
        ...
        fill: function (dataPedido) {
            ...
            Pedido.models.clienteID = dataPedido.clienteID;
        ...
        fillComponent: function () {
            ...
            component.find('.js-pedido-cliente').text(Pedido.models.clienteID);
            component.find('.js-pedido-data').text(Pedido.models.dataPedido);
        },
